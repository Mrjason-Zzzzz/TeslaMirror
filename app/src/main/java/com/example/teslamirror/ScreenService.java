...
public class ScreenService extends Service {
    ...
    private void setupHardwareEncoder() throws IOException {
        ...
        // ==========================================
        // 【核心绝杀纠偏】必须在挂载虚拟大屏前，先行强推编码器启动！
        // 彻底激活底层 BufferQueue 状态机，让 Surface 处于常态化 ACTIVE 生产状态
        isRunning = true;
        mEncoder.start();
        // ==========================================
        
        // 此时挂载处于 ACTIVE 状态的合法 Surface，底层图形合成器（SurfaceFlinger）将全量放行灌入数据流
